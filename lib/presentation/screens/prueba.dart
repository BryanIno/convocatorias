...
class SaludTrabajo2 extends StatefulWidget {
  const SaludTrabajo2({super.key});

  @override
  State<SaludTrabajo2> createState() => _SaludTrabajo2State();
}

class _SaludTrabajo2State extends State<SaludTrabajo2> {
