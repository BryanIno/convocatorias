...
class SaludTrabajo extends StatefulWidget {
  const SaludTrabajo({super.key});

  @override
  State<SaludTrabajo> createState() => _SaludTrabajoState();
}

class _SaludTrabajoState extends State<SaludTrabajo> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/salud');
