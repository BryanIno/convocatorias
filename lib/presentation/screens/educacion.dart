...
class EducacionTrabajo extends StatefulWidget {
  const EducacionTrabajo({super.key});

  @override
  State<EducacionTrabajo> createState() => _EducacionTrabajoState();
}

class _EducacionTrabajoState extends State<EducacionTrabajo> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/educacion');
