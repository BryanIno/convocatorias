...
class ContruccionTrabajo extends StatefulWidget {
  const ContruccionTrabajo({super.key});

  @override
  State<ContruccionTrabajo> createState() => _ContruccionTrabajoState();
}

class _ContruccionTrabajoState extends State<ContruccionTrabajo> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/construccion');
