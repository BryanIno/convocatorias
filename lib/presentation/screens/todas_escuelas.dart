...
class FullEscuelas extends StatefulWidget {
  const FullEscuelas({super.key});

  @override
  State<FullEscuelas> createState() => _FullEscuelasState();
}

class _FullEscuelasState extends State<FullEscuelas> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/');
