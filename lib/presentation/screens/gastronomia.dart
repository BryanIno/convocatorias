...
class GastronomiaTrabajo extends StatefulWidget {
  const GastronomiaTrabajo({super.key});

  @override
  State<GastronomiaTrabajo> createState() => _GastronomiaTrabajoState();
}

class _GastronomiaTrabajoState extends State<GastronomiaTrabajo> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/gastronomia');
