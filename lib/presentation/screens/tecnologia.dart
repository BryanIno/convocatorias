...
class TecnologiaTrabajo extends StatefulWidget {
  const TecnologiaTrabajo({super.key});

  @override
  State<TecnologiaTrabajo> createState() => _TecnologiaTrabajoState();
}

class _TecnologiaTrabajoState extends State<TecnologiaTrabajo> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/tecnologia');
