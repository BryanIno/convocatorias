...
class AdministracionTrabajo extends StatefulWidget {
  const AdministracionTrabajo({super.key});

  @override
  State<AdministracionTrabajo> createState() => _AdministracionTrabajoState();
}

class _AdministracionTrabajoState extends State<AdministracionTrabajo> {
  ...
  Future<void> fetchDataFromAPI() async {
    try {
      final response = await Dio().get(
          'https://api-convocatorias-flhp34d5na-tl.a.run.app/convocatoria/administracion');
